...
class CartScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Cart (${cart.totalCount})', style: TextStyle(color: colorScheme.onSurface)),
        backgroundColor: colorScheme.surface,
      ...
      body: cart.items.isEmpty
          ? Center(
              child: Text('Your cart is empty', style: textTheme.titleMedium?.copyWith(color: colorScheme.onSurface)),
            )
          : SafeArea(
              top: false,
              child: Column(
                        ...
                        Widget image = ClipRRect(
                          ...
                          child: item.imageUrl.startsWith('http')
                              ? Image.network(
                                  ...
                                  height: 56,
                                  fit: BoxFit.cover,
                                  errorBuilder: (c, e, s) => SizedBox(width: 56, height: 56),
                                )
                        ...
                        final qtyControls = Row(
                          ...
                          children: [
                            IconButton(
                              ...
                              onPressed: () => context.read<CartProvider>().decrement(item.id),
                            ...
                            IconButton(
                              constraints: const BoxConstraints(minWidth: 36, minHeight: 36),
                              padding: EdgeInsets.zero,
                              onPressed: () => context.read<CartProvider>().addByFields(
                                    id: item.id,
                                    name: item.name,
                          ...
                          child: Row(
                            children: [
                              ...
                              Expanded(
                                child: Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [title, const SizedBox(height: 2), sub],
                                ),
                              ),
                              const SizedBox(width: 8),
                              Column(
                                ...
                                children: [totalText, const SizedBox(height: 6), qtyControls],
                              ),
                            ],
                          ),
                        );
